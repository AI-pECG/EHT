function [dataout timeout indout] = excludeoutliers(datain, timein,sens)
...
if n < 3
    ...
    S=std(datain)*threshold; % Calculate the sample standard deviation
